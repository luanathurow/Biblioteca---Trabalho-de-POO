...
public class Biblioteca {
    ...
    private List<RegistroLivro> registrosLivro;

    protected Biblioteca() {
        this.acervo = new ArrayList<>();
        clientes = new ArrayList<>();
        this.registrosLivro = new ArrayList<>();
    }
    ...
    public void inicializarRegistrosLivro() {
        this.registrosLivro = new ArrayList<>();
    }

    public List<RegistroLivro> getRegistrosLivro() {
