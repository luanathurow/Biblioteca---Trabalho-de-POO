...
public class BibliotecaApp extends Biblioteca {
    ...
    private RegistroLivro registroLivro = new RegistroLivro();
    ...
    private void processarOpcao(int opcao) {
        switch (opcao) {
            ...
            case 5:
                ...
                case 6:
                try {
                    registroLivro.relatorioEmArquivo(getRegistrosLivro(), "RelatorioLivros.txt");
                } catch (Exception e) {
                    System.out.println("Erro ao executar a opção 6: " + e.getMessage());
                    System.out.println("Causa da exceção: " + e.getCause());
